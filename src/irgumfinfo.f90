...
!  end do
!  print *, "1-factor"
!  call irgum1finfo(npar,param,d,ncat,ucuts,nq,wl,xl,finfo)
!  print "(8e13.4/)", finfo
...
!  end do
!  print *, "2-factor"
!  call irgum2finfo(npar,param,d,ncat,ucuts,nq,wl,xl,finfo)
!  print "(8e13.4/)", finfo
...
subroutine irgum1finfo(npar,th,d,ncat,ucuts,nq,wl,xl,finfo)
  implicit none
...
! inputs 
!   npar = #parameters,
!   param = parameter vector (dimension 2d=npar), th[j]>1
!   d = #items
!   ncat = #categories (ordinal)
!   ucuts = (ncat-1)xd matrix of cutpoints on Uniform(0,1) scale
!   nq = #quadrature points
...
! output:
!   finfo = Fisher information matrix
subroutine irgum2finfo(npar,param,d,ncat,ucuts,nq,wl,xl,finfo)
  implicit none
  integer npar,d,ncat,nq
