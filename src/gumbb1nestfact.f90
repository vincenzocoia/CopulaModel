...
! nested-factor model with Gumbel linking copulas for group to common latent
...
subroutine strgumbb1(npar,th,mgrp,n,dvar,grsize,udata,nq,wl,xl,nllk,grad,hess)
  implicit none
